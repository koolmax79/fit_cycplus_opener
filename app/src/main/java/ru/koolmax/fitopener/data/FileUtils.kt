...
class FileUtils(var context: Context) {
    ...
    fun getPath(uri: Uri): String? {
        ...
        //content://com.huawei.hidisk.fileprovider/root/storage/0403-0201/Android/data/co.xoss/files/xoss/Devices/M1_5CFA/Workouts/20220710045644.fit
                    ...
                    if (!TextUtils.isEmpty(id)) {
                        ...
                        for (contentUriPrefix in contentUriPrefixesToTry) {
                            return try {
                                ...
                                uri.path!!
                                    .replaceFirst("^/document/raw:".toRegex(), "").replaceFirst("^raw:".toRegex(), "")
                            }
                        }
                    }
                } else {
